...
namespace esphome {
namespace custom_sgp30 {

static const char *const TAG = "custom_sgp30";
...
void CustomSGP30Component::setup() {
  ...
  this->pref_ = global_preferences->make_preference<CustomSGP30Baselines>(hash, true);
...
bool CustomSGP30Component::is_sensor_baseline_reliable_() {
...
void CustomSGP30Component::read_iaq_baseline_() {
  ...
  this->set_timeout(50, [this]() {
    ...
    if (eco2baseline != this->eco2_baseline_ || tvocbaseline != this->tvoc_baseline_) {
      ...
      // much
      if (this->is_sensor_baseline_reliable_() && this->store_baseline_ &&
...
void CustomSGP30Component::send_env_data_() {
...
void CustomSGP30Component::write_iaq_baseline_(uint16_t eco2_baseline, uint16_t tvoc_baseline) {
  uint8_t data[7];
...
void CustomSGP30Component::dump_config() {
...
void CustomSGP30Component::update() {
