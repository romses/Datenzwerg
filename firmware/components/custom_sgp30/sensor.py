...
custom_sgp30_ns = cg.esphome_ns.namespace("custom_sgp30")
CustomSGP30Component = custom_sgp30_ns.class_(
    "CustomSGP30Component", cg.PollingComponent, sensirion_common.SensirionI2CDevice
)
...
CONFIG_SCHEMA = (
    cv.Schema(
        {
            cv.GenerateID(): cv.declare_id(CustomSGP30Component),
