...
struct CustomSGP30Baselines {
  uint16_t eco2;
  uint16_t tvoc;
} PACKED;

/// This class implements support for the Sensirion SGP30 i2c GAS (VOC and CO2eq) sensors.
class CustomSGP30Component : public PollingComponent, public sensirion_common::SensirionI2CDevice {
 public:
 ...
 protected:
  ...
  CustomSGP30Baselines baselines_storage_;
